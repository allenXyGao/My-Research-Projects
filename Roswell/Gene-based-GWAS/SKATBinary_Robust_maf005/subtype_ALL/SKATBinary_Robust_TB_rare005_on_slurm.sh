script=/projects/rpci/qzhu/xinyu/mywork/skatO_case_control/scripts/SKATBinary_Robust_maf005/subtype_ALL
...
do 
	...
	echo "$script/SKATBinary_Robust_TB_rare005.R $pop $start $end > $Output/TB_cell_logFiles/$pop/SKATBinary_Robust.$pop.$start-$end.log" >> SKATBinary_Robust.$pop.$start-$end
