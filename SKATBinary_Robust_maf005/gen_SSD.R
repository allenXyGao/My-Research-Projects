...
get_SSDplusInfo_fromCLEANdata <- function(i) {
  ...
  filepath.res="/projects/rpci/qzhu/xinyu/mywork/skatO_case_control/output/SSD_rare_maf005/"
  res.gen_SSD_setID <- Generate_SSD_SetID(File.Bed = paste0(filepath.bin, "CLEAN.rare005.", names_case_cohort$disease_name,"casecontrol_", 
                                          ...
                                          File.Fam = paste0(filepath.bin, "CLEAN.rare005.", names_case_cohort$disease_name,"casecontrol_", 
                                                            names_case_cohort$cohort_name, ".fam"),
                                          File.SetID = paste0(filepath.SetID, "File.SetID.autosome"), 
                                          File.SSD = paste0(filepath.res, names_case_cohort$disease_name,"casecontrol_", 
                                                            names_case_cohort$cohort_name,"/","File.SSD"),
                                          File.Info = paste0(filepath.res, names_case_cohort$disease_name,"casecontrol_", 
